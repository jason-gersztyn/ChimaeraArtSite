<%@ Page Title="Contest Prize Item" Language="C#" MasterPageFile="~/Master/Chimaera.Master" AutoEventWireup="true" CodeBehind="PrizeItem.aspx.cs" Inherits="ChimaeraArtSite.Contest.PrizeItem" %>
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function VariantSelect(ID) {
            $.ajax({
                type: "POST",
                url: "PrizeServices.asmx/FetchVariationData",
            ...
            <table class="itemTable">
                <tr>
                    ...
                    <td class="shopItemSpecs">
                        ...
                        <br />
                        <asp:Button ID="btAdd" runat="server" OnClick="btAdd_Click" Text="Select Prize" CssClass="chimButton" />
                        <br />
