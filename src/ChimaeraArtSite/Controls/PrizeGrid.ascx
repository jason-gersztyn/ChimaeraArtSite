<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrizeGrid.ascx.cs" Inherits="ChimaeraArtSite.Controls.PrizeGrid" %>
...
<asp:ListView runat="server" ID="ShopListView" ItemPlaceholderID="itemPlaceHolder" GroupPlaceholderID="groupPlaceHolder" GroupItemCount="4">
    ...
    <ItemTemplate>
        <td runat="server" id="imageCell" class="imageCell">
            <a id="shopLink" runat="server" href='<%# "~/Contest/PrizeItem.aspx?SeriesID=" + Eval("ProductSeriesID") %>' class="imageLink">
